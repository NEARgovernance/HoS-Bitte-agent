...
export async function GET(request: Request) {
  try {
    ...
    // Create the unselect staking pool transaction payload
    ...
    console.error('Error generating unselect staking pool transaction payload:', error);
    return NextResponse.json({ error: 'Failed to generate unselect staking pool transaction payload' }, { status: 500 });
  }
} 